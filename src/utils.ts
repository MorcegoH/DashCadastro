...
const rawRegionalMap: Record<string, string> = {
  // CEI
  "FABRÍCIA SANTOS FIGUEIREDO": "CEI",
  "HENRIQUE VIANA PRADO": "CEI",
  "HEVELY NOVAIS BONANO": "CEI",
  "LUCAS SOUSA DE MIRANDA": "CEI",
  "REGIONAL CEI": "CEI",

  // CRS
  "ARTHUR GOMES DE CARVALHO": "CRS",
  ...
  "THALIA KATHLEEN DA SILVA RAMOS": "INS",
  ...
  // PLT GO
  "EDUARDO MENEZES DO NASCIMENTO": "PLT GO",
